...
---@return table
---@public
function SertyModuleUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = SertyModuleUI.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = SertyModuleUI.UI.Style[SertyModuleUI.UI.Current].Width
    Menu.Open = false
    Menu.Controls = SertyModuleUI.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + SertyModuleUI.Settings.Items.Subtitle.Text.X, Menu.Y + SertyModuleUI.Settings.Items.Subtitle.Text.Y, 0, SertyModuleUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, SertyModuleUI.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, SertyModuleUI.Menus)
end
...
---@return table
---@public
function SertyModuleUI.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
...
---@return nil
---@public
function SertyModuleUI.Menus:SetTitle(Title)
    self.Title = Title
end
...
---@return nil
---@public
function SertyModuleUI.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function SertyModuleUI.Menus:GetStyleSize()
    if(self.WidthOffset == 100)then
        return "SertyModuleUI"
...
---@return void
---@public
function SertyModuleUI.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function SertyModuleUI.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function SertyModuleUI.Menus:UpdateCursorStyle()
...
---@return void
---@public
function SertyModuleUI.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function SertyModuleUI.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + SertyModuleUI.Settings.Items.Subtitle.Text.X, self.Y + SertyModuleUI.Settings.Items.Subtitle.Text.Y, 0, SertyModuleUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, SertyModuleUI.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function SertyModuleUI.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function SertyModuleUI.Menus:EditSpriteColor(color)
...
---@return nil
---@public
function SertyModuleUI.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function SertyModuleUI.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function SertyModuleUI.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function SertyModuleUI.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "kikizizinazi", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function SertyModuleUI.Menus:Closable(boolean)
...
function SertyModuleUI.Menus:AddInstructionButton(button)
...
function SertyModuleUI.Menus:RemoveInstructionButton(button)
...
function SertyModuleUI.Menus:UpdateInstructionalButtons(Visible)
