...
RegisterNetEvent("SertyModuleUI:Popup")
AddEventHandler("SertyModuleUI:Popup", function(array)
    SertyModuleUI.Popup(array)
end)

---Popup
---@param array table
---@public
function SertyModuleUI.Popup(array)
    ClearPrints()
...
---@param array table
---@public
function SertyModuleUI.PopupChar(array)
    if (array.colors == nil) then
        SetNotificationBackgroundColor(140)
    else
        SetNotificationBackgroundColor(array.colors)
...
---@param array table
---@public
function SertyModuleUI.Text(array)
    ClearPrints()
