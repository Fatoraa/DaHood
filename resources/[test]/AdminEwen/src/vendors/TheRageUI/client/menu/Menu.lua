...
---@return table
---@public
function VIPUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = VIPUI.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = 100
    Menu.Open = false
    Menu.Controls = VIPUI.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + VIPUI.Settings.Items.Subtitle.Text.X, Menu.Y + VIPUI.Settings.Items.Subtitle.Text.Y, 0, VIPUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, VIPUI.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, VIPUI.Menus)
end
...
---@return table
---@public
function VIPUI.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
...
---@return nil
---@public
function VIPUI.Menus:SetTitle(Title)
    self.Title = Title
end
...
---@return nil
---@public
function VIPUI.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function VIPUI.Menus:GetStyleSize()
...
---@return void
---@public
function VIPUI.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function VIPUI.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function VIPUI.Menus:UpdateCursorStyle()
...
---@return void
---@public
function VIPUI.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function VIPUI.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + VIPUI.Settings.Items.Subtitle.Text.X, self.Y + VIPUI.Settings.Items.Subtitle.Text.Y, 0, VIPUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, VIPUI.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function VIPUI.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function VIPUI.Menus:EditSpriteColor(color)
...
---@return nil
---@public
function VIPUI.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function VIPUI.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function VIPUI.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function VIPUI.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "kikizizinazi", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function VIPUI.Menus:Closable(boolean)
...
function VIPUI.Menus:AddInstructionButton(button)
...
function VIPUI.Menus:RemoveInstructionButton(button)
...
function VIPUI.Menus:UpdateInstructionalButtons(Visible)
