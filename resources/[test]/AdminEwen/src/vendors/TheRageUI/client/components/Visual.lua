...
RegisterNetEvent("VIPUI:Popup")
AddEventHandler("VIPUI:Popup", function(array)
    VIPUI.Popup(array)
end)
...
---@param array table
---@public
function VIPUI.PopupChar(array)
    if (array.colors == nil) then
        SetNotificationBackgroundColor(140)
    else
        SetNotificationBackgroundColor(array.colors)
