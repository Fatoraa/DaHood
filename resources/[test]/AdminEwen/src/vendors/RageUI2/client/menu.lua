        ...
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            if CurrentMenu.Sprite ~= nil then
                if CurrentMenu.Sprite.Dictionary ~= nil then
                    if CurrentMenu.Sprite.Dictionary == "kikizizinazi" then
...
function menu.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.Index = 1
    Menu.Sprite = { Dictionary = 'gunwareBanner', Texture = 'gunwareBanner', Color = { R = R, G = G, B = B, A = A } }
    Menu.Rectangle = nil
...
function menu.Menus:EditSpriteColor(R, G, B, A)
    if self.Sprite.Dictionary == "kikizizinazi" then
...
function menu.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "kikizizinazi", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end
            ...
            if Enabled then
                if haveLeftBadge then
                    if (Style.LeftBadge ~= nil) then
                        ...
                        RenderSprite(LeftBadge.BadgeDictionary or "kikizizinazi", LeftBadge.BadgeTexture or "", CurrentMenu.X, CurrentMenu.Y + SettingsButton.LeftBadge.Y + CurrentMenu.SubtitleHeight + menu.ItemOffset, SettingsButton.LeftBadge.Width, SettingsButton.LeftBadge.Height, 0, LeftBadge.BadgeColour and LeftBadge.BadgeColour.R or 255, LeftBadge.BadgeColour and LeftBadge.BadgeColour.G or 255, LeftBadge.BadgeColour and LeftBadge.BadgeColour.B or 255, LeftBadge.BadgeColour and LeftBadge.BadgeColour.A or 255)
                    end
                end
                if haveRightBadge then
                    if (Style.RightBadge ~= nil) then
                        local RightBadge = Style.RightBadge(Active)
                        RenderSprite(RightBadge.BadgeDictionary or "kikizizinazi", RightBadge.BadgeTexture or "", CurrentMenu.X + SettingsButton.RightBadge.X + CurrentMenu.WidthOffset, CurrentMenu.Y + SettingsButton.RightBadge.Y + CurrentMenu.SubtitleHeight + menu.ItemOffset, SettingsButton.RightBadge.Width, SettingsButton.RightBadge.Height, 0, RightBadge.BadgeColour and RightBadge.BadgeColour.R or 255, RightBadge.BadgeColour and RightBadge.BadgeColour.G or 255, RightBadge.BadgeColour and RightBadge.BadgeColour.B or 255, RightBadge.BadgeColour and RightBadge.BadgeColour.A or 255)
                    end
                end
...
local SettingsCheckbox = {
    Dictionary = "kikizizinazi", Textures = {
        "shop_box_blankb", -- 1
        "shop_box_tickb", -- 2
        "shop_box_blank", -- 3
        "shop_box_tick", -- 4
                ...
                if type(Style) == "table" then
                    if Style.Enabled == true or Style.Enabled == nil then
                        ...
                        if type(Style) == 'table' then
                            if Style.LeftBadge ~= nil then
                                if Style.LeftBadge ~= menu.BadgeStyle.None then
                                    ...
                                    RenderSprite(BadgeData.BadgeDictionary or "kikizizinazi", BadgeData.BadgeTexture or "", CurrentMenu.X, CurrentMenu.Y + SettingsButton.LeftBadge.Y + CurrentMenu.SubtitleHeight + menu.ItemOffset, SettingsButton.LeftBadge.Width, SettingsButton.LeftBadge.Height, 0, BadgeData.BadgeColour and BadgeData.BadgeColour.R or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.G or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.B or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.A or 255)
                                end
                            end
                            if Style.RightBadge ~= nil then
                                if Style.RightBadge ~= menu.BadgeStyle.None then
                                    local BadgeData = Style.RightBadge(Selected)
                                    RenderSprite(BadgeData.BadgeDictionary or "kikizizinazi", BadgeData.BadgeTexture or "", CurrentMenu.X + SettingsButton.RightBadge.X + CurrentMenu.WidthOffset, CurrentMenu.Y + SettingsButton.RightBadge.Y + CurrentMenu.SubtitleHeight + menu.ItemOffset, SettingsButton.RightBadge.Width, SettingsButton.RightBadge.Height, 0, BadgeData.BadgeColour and BadgeData.BadgeColour.R or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.G or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.B or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.A or 255)
                                end
                            end
                        end
                    else
                        ...
                        if LeftBadge ~= menu.BadgeStyle.None and LeftBadge ~= nil then
                            ...
                            RenderSprite(BadgeData.BadgeDictionary or "kikizizinazi", BadgeData.BadgeTexture or "", CurrentMenu.X, CurrentMenu.Y + SettingsButton.LeftBadge.Y + CurrentMenu.SubtitleHeight + menu.ItemOffset, SettingsButton.LeftBadge.Width, SettingsButton.LeftBadge.Height, 0, BadgeData.BadgeColour.R or 255, BadgeData.BadgeColour.G or 255, BadgeData.BadgeColour.B or 255, BadgeData.BadgeColour.A or 255)
                        end
                    end
...
local SettingsButton = {
    ...
    RightBadge = { X = 385, Y = -2, Width = 40, Height = 40 },
    RightText = { X = 420, Y = 4, Scale = 0.35 },
    SelectedSprite = { Dictionary = "kikizizinazi", Texture = "gradient_nav", Y = 15, Width = 195, Height = 4 },
}
...
---@type table
local SettingsList = {
    LeftArrow = { Dictionary = "kikizizinazi", Texture = "arrowleft", X = 378, Y = 3, Width = 30, Height = 30 },
    RightArrow = { Dictionary = "kikizizinazi", Texture = "arrowright", X = 400, Y = 3, Width = 30, Height = 30 },
...
local SettingsSlider = {
    ...
    LeftArrow = { Dictionary = "kikizizinazitu", Texture = "arrowleft", X = 235, Y = 11.5, Width = 15, Height = 15 },
    RightArrow = { Dictionary = "kikizizinazitu", Texture = "arrowright", X = 400, Y = 11.5, Width = 15, Height = 15 },
}
...
---@type table
local Colour = {
    Background = { Dictionary = "kikizizinazi", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 112 },
    LeftArrow = { Dictionary = "kikizizinazi", Texture = "arrowleft", X = 7.5, Y = 15, Width = 30, Height = 30 },
    RightArrow = { Dictionary = "kikizizinazi", Texture = "arrowright", X = 393.5, Y = 15, Width = 30, Height = 30 },
...
local Slider = {
    Background = { Dictionary = "kikizizinazi", Texture = "gradient_bgd", Y = 50, Width = 431, Height = 76 },
    Text = {
    ...
    LeftArrow = { Dictionary = "kikizizinazi", Texture = "arrowleft", X = 12, Y = 80, Width = 25, Height = 25 },
    RightArrow = { Dictionary = "kikizizinazi", Texture = "arrowright", X = 389, Y = 80, Width = 25, Height = 25 },
}
...
function menu.SliderPanel(Value, MinValue, UpperText, MaxValue, Actions, Index)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and ((CurrentMenu.Index == Index)) then
            ...
            RenderSprite("kikizizinazi", "gradient_bgd", CurrentMenu.X, CurrentMenu.Y + Slider.Background.Y + CurrentMenu.SubtitleHeight + menu.ItemOffset, Slider.Background.Width + CurrentMenu.WidthOffset, Slider.Background.Height, 0.0, 255, 255, 255, 255)
