...
AddEventHandler('esx_basicneeds:resetStatus', function()
	...
	TriggerEvent('esx_status:set', 'stress', 500000)
...
RegisterNetEvent('esx_basicneeds:onStress')

AddEventHandler('esx_basicneeds:onStress', function(prop_name)
	...
	if not IsAnimated then
		...
		Citizen.CreateThread(function()
			...
			exports['Arp_Notifications']:ArpShowProgressBar(10000, "Prendre une pilule de piment ...")
			...
			ESX.Streaming.RequestAnimDict(lib, function()
				...
				ESX.Streaming.RequestAnimDict(lib, function()
					...
					TaskPlayAnim(playerPed, lib, anim, 8.0, 1.0, -1, 2, 0, 0, 0, 0 )

					Citizen.Wait(2800)

					ClearPedTasks(playerPed)

					if(isIncrementalChill == false)then

						isIncrementalChill = true

						ESX.ShowNotification("Vous remarquez comment votre anxiété commence à diminuer...")

						local stress = 1000000
						...
						Citizen.CreateThread(function()
							...
							print('start incremental chillpill')

							while count < 60 * 2 and stress > 10000 do
							...
							isIncrementalChill = false

							print('end incremental chillpill')
...
AddEventHandler('esx_basicneeds:onPill', function(prop_name)
	...
	if not IsAnimated then
		...
		ESX.Streaming.RequestAnimDict(lib, function()
			...
			ExecuteCommand("me se toma una pastilla y empezaria a olvidar todo...")
			...
			ExecuteCommand("do no podria moverse durante un tiempo")
...
RegisterNetEvent('esx_basicneeds:onDrinkjoint')

AddEventHandler('esx_basicneeds:onDrinkjoint', function(prop_name)
...
function SmokeAnimation()
	...
	Citizen.CreateThread(function()
        ...
        TaskStartScenarioInPlace(playerPed, "WORLD_HUMAN_SMOKING_POT_CLUBHOUSE", 0, true)               
