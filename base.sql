...
--
-- Hôte : localhost:3306
-- Généré le : ven. 23 déc. 2022 à 18:46
-- Version du serveur : 10.8.3-MariaDB-1:10.8.3+maria~bullseye
...
(1, 'unemployed', 0, 'unemployed', 'RSA', 0, '{}', '{}'),
(2, 'unemployed2', 0, 'unemployed2', 'Sans Emploi', 0, '{}', '{}');
...
CREATE TABLE `users` (
  ...
  `position` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '{"x": -1077.544921875,"y":-2807.5866699219,"z":21.343173980713,"heading":333.27}',
